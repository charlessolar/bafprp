...
{
	printf( 
		"Usage: bafprp [-v+] [-rTYPE] [-lTYPE] [-eTYPE] [-poprop:value] file[s]\n"
		"\n"
		...
		"      The 'o' character in the example indicates which type of output\n"
		"      e for error\n"
		"      r for record\n"
		"      l for log\n"
		"      Immediatly after that letter follows the property name, then a ':'\n"
		"      delimitor followed by the value for that property\n"
		"      For a list of properties either see the output source, or visit\n"
		"      the web site\n"
		"\n"
